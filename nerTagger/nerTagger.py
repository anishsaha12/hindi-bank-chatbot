...
with open('max_len_char_prefix.pkl', 'rb') as f:
    max_len_char_prefix = pickle.load(f)

with open('max_len_char_suffix.pkl', 'rb') as f:
    max_len_char_suffix = pickle.load(f)

with open('word2pos.pkl', 'rb') as f:
    word2pos = pickle.load(f)
    
with open('word2idx.pkl', 'rb') as f:
    word2idx = pickle.load(f)

with open('pos2idx.pkl', 'rb') as f:
...
model = load_model('word_pos_char_emb_bilstm_ner_tagger.h5')
